package shiro.dubbo.cache.token.manager;
...
import shiro.dubbo.bean.bo.UserOnlineBo;
import shiro.dubbo.bean.model.UUser;
import shiro.dubbo.common.utils.SpringContextUtil;
import shiro.dubbo.cache.session.CustomSessionManager;
import shiro.dubbo.cache.token.SampleRealm;
import shiro.dubbo.cache.token.ShiroToken;
...
public class TokenManager {
	 ...
	 * @return
	 */
	public static Long getUserId(Serializable sessionId) {
		UserOnlineBo userOnlineBo = customSessionManager.getSession(String.valueOf(sessionId));
		return Long.valueOf(userOnlineBo.getId());
	}
}
