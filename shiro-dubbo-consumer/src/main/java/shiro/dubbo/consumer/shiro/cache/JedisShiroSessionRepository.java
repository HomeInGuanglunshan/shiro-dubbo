package shiro.dubbo.consumer.shiro.cache;
...
import shiro.dubbo.common.utils.SerializeUtil;
import shiro.dubbo.consumer.shiro.session.CustomSessionManager;
import shiro.dubbo.consumer.shiro.session.SessionStatus;
import shiro.dubbo.consumer.shiro.session.ShiroSessionRepository;
...
public class JedisShiroSessionRepository implements ShiroSessionRepository {
	...
	public void saveSession(Session session) {
		...
		try {
			 ...
			 * 的概念才会失效 我原来是存储session的有效期会比session的有效期会长，而且最终session的有效期是在这里【
			 * SESSION_VAL_TIME_SPAN】设置的。
			 *
